---
id: "019"
titulo: "Cinctorres, poble de teixidors"
notas: "AUTORIA DUBTOSA: va firmat al final per Reinalda Artola Mestre ('Reina', agost 2018). Cançons i versos sobre els teixidors, els faixeros i la Mare de Déu de Gràcia, amb el poema 'El jardí'. Hi havia un fragment curt duplicat al pendrive, eliminat."
---
...
passat dema tinc que anar  
i me les tinc que emportar  
i al carro les tinc que carregar.  
...
Si se posen a cantar cançons del record  
Joseret i la rondalla n’era  
cantàvem més de vint  
que les porten a la anella  
de la faixa nugades en un fil.  
per cantar a tot un poble  
ahuí serè rondaller  
amb paraules ardoroses  
que dins del cor traure  
cantarem per tot Cinctorres  
per tot Cinctorres cantarem  
recordant que fa 150 anys  
l’ermita de la patrona  
se va acabar de fer.  
