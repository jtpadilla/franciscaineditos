...
export const OBRES: Record<string, { nom: Record<Lang, string>; desc: Record<Lang, string>; tipus: 'llibre' | 'recull' }> = {
  'memoria-familiar': {
...
export const T = {
  ...
  llibre: { ca: 'llibre', es: 'libro' },
  recull: { ca: 'recull', es: 'colección' },
